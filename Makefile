...
_pkg-control:
	...
	echo "Version: $(PKG_VERSION)-$(PKG_REVISION)" >> out/$(BUILD_DIR)/control/control
...
_pkg-ipk:
	...
	cd out/$(BUILD_DIR); \
	tar czvf ../$(PACKAGE)_$(PKG_VERSION)-$(PKG_REVISION).ipk control.tar.gz data.tar.gz debian-binary; \
	cd ../..
